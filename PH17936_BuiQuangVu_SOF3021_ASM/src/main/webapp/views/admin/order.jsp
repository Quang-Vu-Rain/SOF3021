				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/store"
							modelAttribute="ord">
					...
					<tbody>
						<c:forEach items="${ ordview.content }" var="ord">
							<tr>
									...
									<div class="modal fade" id="update${ ord.id }" tabindex="-1"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form:form method="POST"
													action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/update/${ ord.id }"
													modelAttribute="ord">
													<div class="modal-body">
														<div class="mt-4">
															<form:select name="accounts" path="accounts"
								...
								<td>
									<!-- Form --> <a class="btn btn-danger" href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/detail/${ ord.id }"> Chi tiết</a>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<nav aria-label="..." class="ms-2">
				<ul class="pagination">
					<li class="page-item ${ page == 0 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/index?page=${ page - 1 }&field=${ field }">Previous</a></li>
					<c:forEach var="index" begin="0" end="${ ordview.totalPages - 1 }">
						<li class="page-item ${ index == page ? "
							...
							href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/ord/index?page=${ index }&field=${ field }">
					...
					<li class="page-item ${ page == ordview.totalPages - 1 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/index?page=${ page + 1 }&field=${ field }">Next</a>
					</li>
				</ul>
			</nav>
		</div>
