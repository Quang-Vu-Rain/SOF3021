				...
				<div class="modal-dialog">
					<div class="modal-content rounded-0">
						...
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/store"
					...
					<tbody>
						<c:forEach items="${ accview.content }" var="acc">
							<tr>
								...
								<td>${ acc.email }</td>
								<td><img
									src="/PH17936_BuiQuangVu_SOF3021_ASM/images/${ acc.photo }"
									...
									<div class="modal fade" id="update${ acc.id }" tabindex="-1"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form:form method="POST"
													action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/update/${ acc.id }"
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-success"
														href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/delete/${ acc.id }">Yes</a>
												</div>
											</div>
										</div>
									</div> <!-- Form -->
			...
			<nav aria-label="..." class="ms-2">
				<ul class="pagination">
					<li class="page-item ${ page == 0 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/index?page=${ page - 1 }&field=${ field }">Previous</a></li>
					<c:forEach var="index" begin="0" end="${ accview.totalPages - 1 }">
						<li class="page-item ${ index == page ? "
							...
							href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/index?page=${ index }&field=${ field }">
					...
					<li class="page-item ${ page == accview.totalPages - 1 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/index?page=${ page + 1 }&field=${ field }">Next</a>
					</li>
				</ul>
			</nav>
		</div>
...
$('button[type=submit]').click(function(e) {				   
    ...
    $.post({
       ...
       url : 'http://localhost:8080/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/store',

       data : $('form[name=account]').serialize(),
