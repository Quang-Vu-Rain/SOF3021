				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/orderdetail/store"
									...
									<div class="modal fade" id="update${ ordetail.id }"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form:form method="POST"
													action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/orderdetail/update/${ ordetail.id }"
													modelAttribute="ordetail">
													<div class="modal-body">
														<div class="mt-4">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-success"
														href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/orderdetail/delete/${ ordetail.id }">Yes</a>
												</div>
											</div>
										</div>
									</div> <!-- Form -->
			...
			<nav aria-label="..." class="ms-2">
				<ul class="pagination">
					<li class="page-item ${ page == 0 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/orderdetail/index?page=${ page - 1 }&field=${ field }">Previous</a></li>
					<c:forEach var="index" begin="0"
						...
						<li class="page-item ${ index == page ? "
							...
							href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/ordetail/index?page=${ index }&field=${ field }">
					...
					<li class="page-item ${ page == ordetailview.totalPages - 1 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/orderdetail/index?page=${ page + 1 }&field=${ field }">Next</a>
					</li>
				</ul>
			</nav>
		</div>
