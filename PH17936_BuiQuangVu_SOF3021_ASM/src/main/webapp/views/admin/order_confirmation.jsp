							...
							<tr>
								<td>
									<div class="d-flex align-items-center">
										<img src="/PH17936_BuiQuangVu_SOF3021_ASM/images/${ ordetail.products.image }" alt="" style="width: 100px; height: 100px"
								...
								<td>
									<div class="d-flex justify-content-center align-items-center">
										<a
											href="/PH17936_BuiQuangVu_SOF3021_ASM/user/dec/${ ordetail.id }?sl=${ ordetail.quantity }"
											...
											href="/PH17936_BuiQuangVu_SOF3021_ASM/user/inc/${ ordetail.id }?sl=${ ordetail.quantity }"
											class="p-1" style="background-color: #F2AF5C; color: white;"><i
					...
					<c:if test="${ order.status != 2 }">
						<div
							...
							<a class="btn shadow-0 rounded-0 me-3 fs-5"
								href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/success/${ order.id }"
								style="background-color: #161459; color: #F2AF5C">Xác nhận</a> <a
								class="btn shadow-0 rounded-0 fs-5"
								href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/order/cancel/${ order.id }"
