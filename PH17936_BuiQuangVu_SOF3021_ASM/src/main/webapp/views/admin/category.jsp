				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/category/store"
							modelAttribute="cate">
									...
									<div class="modal fade" id="update${ cate.id }" tabindex="-1"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form:form method="POST"
													action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/category/update/${ cate.id }"
													modelAttribute="cate">
													<div class="modal-body">
														<div>
															<div class="form-outline">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-success"
														href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/category/delete/${ cate.id }">Yes</a>
												</div>
											</div>
										</div>
									</div> <!-- Form -->
			...
			<nav aria-label="..." class="ms-2">
				<ul class="pagination">
					<li class="page-item ${ page == 0 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/category/index?page=${ page - 1 }&field=${ field }">Previous</a></li>
					...
					<li class="page-item ${ page == cateview.totalPages - 1 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/category/index?page=${ page + 1 }&field=${ field }">Next</a>
					</li>
				</ul>
			</nav>
		</div>
