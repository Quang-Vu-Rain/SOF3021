				...
				<div class="modal-dialog">
					<div class="modal-content rounded-0">
						...
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/store"
					...
					<tbody>
						<c:forEach items="${ proview.content }" var="pro">
							<tr>
								<td>${ pro.id }</td>
								<td>${ pro.name }</td>
								<td><img src="/PH17936_BuiQuangVu_SOF3021_ASM/images/${ pro.image }"
									...
									<div class="modal fade" id="update${ pro.id }" tabindex="-1"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form:form method="POST"
													action="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/update/${ pro.id }"
													modelAttribute="pro" enctype="multipart/form-data">
													<div class="modal-body">
														<div>
															<div class="form-outline">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-success"
														href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/delete/${ pro.id }">Yes</a>
												</div>
											</div>
										</div>
									</div> <!-- Form -->
			...
			<nav aria-label="..." class="ms-2">
				<ul class="pagination">
					<li class="page-item ${ page == 0 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/index?page=${ page - 1 }&field=${ field }">Previous</a></li>
					<c:forEach var="index" begin="0" end="${ proview.totalPages - 1 }">
						<li class="page-item ${ index == page ? "
							...
							href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/index?page=${ index }&field=${ field }">
					...
					<li class="page-item ${ page == proview.totalPages - 1 ? "disabled" : "" }"><a
						class="page-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/product/index?page=${ page + 1 }&field=${ field }">Next</a>
					</li>
				</ul>
			</nav>
		</div>
