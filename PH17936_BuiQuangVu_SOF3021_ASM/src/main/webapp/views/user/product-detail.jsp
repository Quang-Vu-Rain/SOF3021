	...
	<div class="container">
		<div class="row pt-3 pb-3">
			...
			<div class="col-5 p-0 mt-3">
				<img alt="" src="/PH17936_BuiQuangVu_SOF3021_ASM/images/${ pro.image }" style="height: 550px; width: 500px">
			</div>
			<div class="col-7 mt-3 bg-white">
				<p class="fw-bold fs-3">${ pro.name }</p>
				<p class="fw-bold fs-3">${ pro.price }VNĐ</p>
				<p class="fs-5">Áo sơ mi 100% cotton cao cấp với cảm giác mềm
					mại tuyệt vời và kiểu dáng đơn giản tinh tế.</p>
				...
				<div class="btn-group shadow-0">
					...
					<input type="radio" class="btn-check rounded-0" name="options1"
						...
						class="btn btn-warning fw-bold rounded-0" for="option6">Be</label>
				</div>
				</p>
				...
				<div class="d-flex justify-content-start align-items-center">
					...
					<div class=" ms-4">
						<a class="btn shadow-0 fw-bold fs-6 text-white rounded-0"
							href="/PH17936_BuiQuangVu_SOF3021_ASM/user/order/${ pro.id }"
