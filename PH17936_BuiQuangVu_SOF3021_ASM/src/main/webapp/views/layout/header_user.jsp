			...
			<div class="d-flex ms-3">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/PH17936_BuiQuangVu_SOF3021_ASM/index">Home</a></li>
			...
			<c:if test="${ sessionScope.acc != null }">
				<ul class="navbar-nav flex-row">
					<li class="nav-item me-3 me-lg-1"><a class="nav-link"
						href="/PH17936_BuiQuangVu_SOF3021_ASM/user/cart"> <span><i
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<c:if test="${ sessionScope.acc.admin != 0 }">
								<li><a class="dropdown-item"
									href="/PH17936_BuiQuangVu_SOF3021_ASM/user/cart">Cart</a></li>
								<li><a class="dropdown-item"
									href="/PH17936_BuiQuangVu_SOF3021_ASM/user/history">History</a></li>
							</c:if>
							<c:if test="${ sessionScope.acc.admin == 0 }">
								<li><a class="dropdown-item"
									href="/PH17936_BuiQuangVu_SOF3021_ASM/admin/account/index">Admin</a></li>
							</c:if>
							<li><a class="dropdown-item"
								href="/PH17936_BuiQuangVu_SOF3021_ASM/user/logout">Log Out</a></li>
						</ul></li>
				</ul>
			</c:if>
			<!-- Right elements -->
				...
				<div class="row">
					<div class="col-7 p-0 m-0 pe-1">
						<img class="img-fluid" style="height: 450px; width: 500px" alt=""
							src="http://anhvienpiano.com/wp-content/uploads/2018/08/dich-vu-chup-anh-thoi-trang-cho-shop-quan-ao-dep-gia-re-768x615.jpg">
					</div>
					<div class="col-5 p-0 m-0">
						<div class="fw-bold fs-4 text-center"
							style="background-color: #161459; color: #F2AF5C">Dawn Shop
							Login</div>
						<form:form method="POST"
							action="/PH17936_BuiQuangVu_SOF3021_ASM/user/login"
							modelAttribute="acc">
							<div class="mt-4">
